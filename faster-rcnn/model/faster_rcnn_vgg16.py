...
from model.region_proposal_network import fixed_RegionProposalNetwork
...
class fixed_FasterRCNNVGG16(FasterRCNN):
    """Faster R-CNN based on VGG-16.
    For descriptions on the interface of this model, please refer to
    :class:`model.faster_rcnn.FasterRCNN`.
    ...
    def __init__(self,
        ...
        extractor, classifier = fixed_decom_vgg16()

        rpn = fixed_RegionProposalNetwork(
            512, 512,
            ratios=ratios,
            anchor_scales=anchor_scales,
            feat_stride=self.feat_stride,
        ...
        super(fixed_FasterRCNNVGG16, self).__init__(
            extractor,
            rpn,
            head,
        )
...
class fixed_VGG16RoIHead(nn.Module):
    """Faster R-CNN Head for VGG-16 based implementation.
    This class is used as a head for Faster R-CNN.
    This outputs class-wise localizations and classification based on feature
    maps in the given RoIs.
